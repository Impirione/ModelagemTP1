...
export const mockProcessos: Processo[] = [
  {
    ...
    logs: [
      {
        id: 'l1',
        responsavelUsuario: 'u1',
        acaoRealizada: 'CRIACAO',
        entidadeAfetada: 'Processo',
        entidadeId: '1',
        detalhes: 'Processo criado com proposta 789456',
        dataHora: new Date('2024-05-15:08:00:00'),
      },
    ],
  ...
  },
  {
    ...
    logs: [
      {
        id: 'l2',
        responsavelUsuario: 'u2',
        acaoRealizada: 'CRIACAO',
        entidadeAfetada: 'Processo',
        entidadeId: '2',
        detalhes: 'Processo criado com proposta 123456',
        dataHora: new Date('2024-05-14:14:30:00'),
      },
      {
        id: 'l3',
        responsavelUsuario: 'u3',
        acaoRealizada: 'APROVACAO',
        entidadeAfetada: 'Processo',
        entidadeId: '2',
        detalhes: 'Gerente aprovou o processo',
        dataHora: new Date('2024-05-16:17:55:03'),
      },
    ],
    ...
    logs: [
      {
        ...
        entidadeAfetada: 'Processo',
        entidadeId: '3',
        detalhes: 'Processo criado com proposta 456753',
        dataHora: new Date('2024-05-09:14:00:00'),
      },
      {
        id: 'l5',
        responsavelUsuario: 'u3',
        ...
        entidadeId: '3',
        detalhes: 'Gerente aprovou o processo',
        dataHora: new Date('2024-05-10:14:20:59'),
      },
    ],
...
export const mockUsers: User[] = [
  ...
  {
    id: 'u7',
    nome: 'Fernanda Secretaria',
    email: 'fernanda@vianuvem.com',
    role: 'secretaria',
    ativo: true,
  ...
  {
    id: 'u8',
    nome: 'Lucas Liberacao',
    email: 'lucas@vianuvem.com',
    role: 'liberacao',
    ativo: true,
